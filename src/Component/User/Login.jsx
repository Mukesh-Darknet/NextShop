...
function Login() {
  return (
    <>
      ...
      <div className="bg-white  w-full  flex flex-row min-h-screen justify-center items-center">

        < div className="isolate bg-amber-300 px-6 py-24 sm:py-32 lg:px-8 w-4/5    shadow-2xl">
          <div
            aria-hidden="true"
...
/> */}
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-xl text-black mt-8">Create your account to get full access </p>
          ...
          <form action="#" method="POST" className="mx-auto mt-8 max-w-xl sm:mt-20">
            ...
            <div className="text-black mt-8 ml-16">
              <p className="text-xl">Already have an account?<Link to="/login" className="text-red-600">Login</Link> here</p>
            </div>
          </form>
        </div >
